...
export async function extractZip(arrayBuffer, { onlyPaths } = {}) {
  ...
  // Si el que llama solo necesita un subconjunto (por ejemplo, una sola
  // tanda de 15 archivos de un proyecto de 300), no tiene sentido
  // descomprimir los otros 285 solo para descartarlos despues — eso es
  // justo lo que hacia explotar la memoria en proyectos grandes. Se
  // descomprime unicamente lo pedido.
  const onlySet = onlyPaths ? new Set(onlyPaths) : null;
